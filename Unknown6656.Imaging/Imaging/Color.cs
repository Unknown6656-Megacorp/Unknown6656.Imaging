...
{
    internal static Dictionary<ConsoleColorScheme, Dictionary<SysConsoleColor, uint>> ConsoleColorSchemes { get; } = new()
    {
        [ConsoleColorScheme.Legacy] = new()
        {
            [SysConsoleColor.Black      ] = 0xff000000u,
            [SysConsoleColor.DarkBlue   ] = 0xff000080u,
            [SysConsoleColor.DarkGreen  ] = 0xff008000u,
            [SysConsoleColor.DarkCyan   ] = 0xff008080u,
            [SysConsoleColor.DarkRed    ] = 0xff800000u,
            [SysConsoleColor.DarkMagenta] = 0xff800080u,
            [SysConsoleColor.DarkYellow ] = 0xff808000u,
            [SysConsoleColor.Gray       ] = 0xffc0c0c0u,
            [SysConsoleColor.DarkGray   ] = 0xff808080u,
            [SysConsoleColor.Blue       ] = 0xff0000ffu,
            [SysConsoleColor.Green      ] = 0xff00ff00u,
            [SysConsoleColor.Cyan       ] = 0xff00ffffu,
            [SysConsoleColor.Red        ] = 0xffff0000u,
            [SysConsoleColor.Magenta    ] = 0xffff00ffu,
            [SysConsoleColor.Yellow     ] = 0xffffff00u,
            [SysConsoleColor.White      ] = 0xffffffffu,
        },
        [ConsoleColorScheme.Windows10] = new()
        {
            [SysConsoleColor.Black      ] = 0xff0c0c0cu,
            [SysConsoleColor.DarkBlue   ] = 0xff0037dau,
            [SysConsoleColor.DarkGreen  ] = 0xff13a10eu,
            [SysConsoleColor.DarkCyan   ] = 0xff3a96ddu,
            [SysConsoleColor.DarkRed    ] = 0xffc50f1fu,
            [SysConsoleColor.DarkMagenta] = 0xff881798u,
            [SysConsoleColor.DarkYellow ] = 0xffc19c00u,
            [SysConsoleColor.Gray       ] = 0xffccccccu,
            [SysConsoleColor.DarkGray   ] = 0xff767676u,
            [SysConsoleColor.Blue       ] = 0xff3b78ffu,
            [SysConsoleColor.Green      ] = 0xff16c60cu,
            [SysConsoleColor.Cyan       ] = 0xff61d6d6u,
            [SysConsoleColor.Red        ] = 0xffe74856u,
            [SysConsoleColor.Magenta    ] = 0xffb4009eu,
            [SysConsoleColor.Yellow     ] = 0xfff9f1a5u,
            [SysConsoleColor.White      ] = 0xfff2f2f2u,
        }
    };
