...
public static unsafe class BitmapExtensions
{
    ...
    public static Scalar GetZeroMeanNormalizedCrossCorrelation(this Bitmap first, Bitmap second)
    {
        ...
        return BitmapExtensions.LockRGBAPixels(first, (fst, w, h) =>
            BitmapExtensions.LockRGBAPixels(second, (snd, _, _) =>
            {
                int total = w * h;
                double avg1 = 0;
                double avg2 = 0;
    ...
    public static DensityFunction<RGBAColor> GetHistogram(this Bitmap bmp) => ToPixelArray(bmp).GenerateDensityFunction();
    ...
    public static RegressionDataSet1D GetLumaHistogram(this Bitmap bmp) => ToLumaMask(bmp).GetHistogram();

    public static RegressionDataSet1D GetAlphaHistogram(this Bitmap bmp) => ToAlphaMask(bmp).GetHistogram();

    public static RegressionDataSet1D GetSaturationHistogram(this Bitmap bmp) => ToSaturationMask(bmp).GetHistogram();
