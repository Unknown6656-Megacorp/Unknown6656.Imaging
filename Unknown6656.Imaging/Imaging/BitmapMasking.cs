    ...
    : PartialBitmapEffect.Accelerated
{
    ...
    public Bitmap Composite(Bitmap bottom, Bitmap top)
    {
        ...
        BitmapExtensions.LockRGBAPixels(Bitmap, (mask, mw, mh) =>
    ...
    public (Bitmap masked, Bitmap inverted) Split(Bitmap bitmap)
    {
        ...
        BitmapExtensions.LockRGBAPixels(Bitmap, (mask, mw, mh) =>
        BitmapExtensions.LockRGBAPixels(bitmap, (source, w, h) =>
    ...
    public RegressionDataSet1D GetHistogram()
    {
        ...
        BitmapExtensions.LockRGBAPixels(Bitmap, (ptr, w, h) => hist = new RegressionDataSet1D(Enumerable.Range(0, w * h).Select(i => (Scalar)ptr[i].Average)));
